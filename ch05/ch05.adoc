...
[source]
[[db_init]]
.`db.simplified.c` - Checking if the database already exists or is new and then setting it up
----
include::./code/db.simplified.c[tags=db_init]
----
...
.`db.simplified.c` - Initializing the file on startup
----
include::./code/db.simplified.c[tags=db_init_file_structure]
----
...
.`db.simplified.c` - Validating the file on startup
----
include::./code/db.simplified.c[tags=db_init_from_existing_file]
----
...
.`db.simplified.c` - Validating the file header
----
include::./code/db.simplified.c[tags=db_validate_file_header]
----
