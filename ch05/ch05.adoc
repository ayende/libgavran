...
----
include::./code/main.c[tags=txn_allocate_page]
----

The code in Listing 5.13 will print the new allocated page number (2) and the string "Hello Gavran". We still have work to do on the infrastructure, but we
