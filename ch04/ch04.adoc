...
note that this is a simplified version of what we'll have in the future. We'll update this function in the future. When looking at the code, whenever you see a function 
decorated with a `weak_symbol` annotation, you can assume that a later chapter will update that function definition. 
