...
You can see the tests in <<tests09>>. Note that there are some tricks that I had to employ here. Testing of WAL truncation or corruption was actually hard, because of
